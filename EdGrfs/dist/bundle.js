var bundle = (function (exports) {
    ...
    class Line extends GeometricFigure {
        constructor(position, size, color = { r: 214, g: 14, b: 14, a: 1 }, lineWidth = 10, lineStyle = 'solid') {
    ...
    class TriaCreationTool extends CreationTool {
        createFigure(ptPressed, ptReleased) {
            if (!!ptPressed && !!ptReleased) {
                return new Triangle({
                    x: ptPressed.offsetX,
    ...
    class Rombo extends GeometricFigure {
    ...
    class RombCreationTool extends CreationTool {
        createFigure(ptPressed, ptReleased) {
            if (!!ptPressed && !!ptReleased) {
                return new Rombo({
                    x: ptPressed.offsetX,
    ...
    class MainWindow {
        constructor() {
            ...
            this.tools[MainWindow.TRIA_TOOL] = new TriaCreationTool();
            this.tools[MainWindow.TEXT_TOOL] = new TextCreationTool();
            this.tools[MainWindow.ELLI_TOOL] = new ElliCreationTool();
            this.tools[MainWindow.ROMB_TOOL] = new RombCreationTool();
    ...
    MainWindow.TRIA_TOOL = 5;
    MainWindow.ROMB_TOOL = 6;
