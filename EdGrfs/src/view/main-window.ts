...
import { TriaCreationTool } from './tria-creation-tool';
import { TextCreationTool } from './text-creation-tool';
import { ElliCreationTool } from './elli-creation-tool';
import { RombCreationTool } from './romb-creation-tool';
...
export class MainWindow {
    ...
    static readonly TRIA_TOOL: number = 5;
    static readonly ROMB_TOOL: number = 6;
